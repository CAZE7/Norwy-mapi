...
Die als `steder_v25_1393.csv` und `steder_v25_1393.geojson` veröffentlichte bereinigte Ortsdatenbank wird unter ODbL 1.0 bereitgestellt. Sie enthält 1.393 eindeutige Koordinaten. Zusammengeführte Namen stehen im Feld `aliases`; die Zahl der zusammengeführten Ausgangsdatensätze im Feld `merged_records`. Auswahl, Kategorisierung und Kurzbeschreibungen sind Teil dieser Veröffentlichung.
