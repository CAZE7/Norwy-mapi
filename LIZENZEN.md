...
Die als `steder_v23_1397.csv` und `steder_v23_1397.geojson` veröffentlichte bereinigte Ortsdatenbank wird unter ODbL 1.0 bereitgestellt. Sie enthält 1.397 eindeutige Koordinaten. Zusammengeführte Namen stehen im Feld `aliases`; die Zahl der zusammengeführten Ausgangsdatensätze im Feld `merged_records`. Auswahl, Kategorisierung und Kurzbeschreibungen sind Teil dieser Veröffentlichung.
